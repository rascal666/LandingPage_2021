...
class Ondata {
    constructor(dom) {
        ...
        this.set1ElementData()
        // =================================================================

    };
    set1ElementData () {
        // console.log(this.domContent.innerHTML);
        // console.log(domContent.innerHTML = domContent.innerHTML.replace(/увеличить/gi, 'fff'));
        // this.domContent.innerHTML = 'vfvfvfvfv'
        // domContent.innerHTML = domContent.innerHTML.replace(/увеличить/gi, 'fff')
